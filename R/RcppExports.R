...
als_explicit_double <- function(m_csc_r, X, Y, X_implicit, XtX_implicit, cnt_X, lambda, n_threads, solver, cg_steps, dynamic_lambda, with_implicit_features, with_biases, is_x_bias_last_row) {
    .Call(`_rsparse_als_explicit_double`, m_csc_r, X, Y, X_implicit, XtX_implicit, cnt_X, lambda, n_threads, solver, cg_steps, dynamic_lambda, with_implicit_features, with_biases, is_x_bias_last_row)
}

als_explicit_float <- function(m_csc_r, X_, Y_, X_implicit_, XtX_implicit_, cnt_X_, lambda, n_threads, solver, cg_steps, dynamic_lambda, with_implicit_features, with_biases, is_x_bias_last_row) {
    .Call(`_rsparse_als_explicit_float`, m_csc_r, X_, Y_, X_implicit_, XtX_implicit_, cnt_X_, lambda, n_threads, solver, cg_steps, dynamic_lambda, with_implicit_features, with_biases, is_x_bias_last_row)
}
...
solve_implicit_features_double <- function(m_csc_r, X, lambda, dynamic_lambda, with_user_item_bias, non_negative, n_threads) {
    .Call(`_rsparse_solve_implicit_features_double`, m_csc_r, X, lambda, dynamic_lambda, with_user_item_bias, non_negative, n_threads)
}

solve_implicit_features_float <- function(m_csc_r, X_, lambda, dynamic_lambda, with_user_item_bias, non_negative, n_threads) {
    .Call(`_rsparse_solve_implicit_features_float`, m_csc_r, X_, lambda, dynamic_lambda, with_user_item_bias, non_negative, n_threads)
}
