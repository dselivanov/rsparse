...
warp_solver_double <- function(m_csc_r, W, H, rank = 8L, n_updates = 1e5L, learning_rate = 0.01, momentum = 0.8, lambda_user = 0.0, lambda_item_positive = 0.0, lambda_item_negative = 0.0, n_threads = 1L, update_items = TRUE, solver, max_negative_samples = 50L, margin = 0.1) {
    invisible(.Call(`_rsparse_warp_solver_double`, m_csc_r, W, H, rank, n_updates, learning_rate, momentum, lambda_user, lambda_item_positive, lambda_item_negative, n_threads, update_items, solver, max_negative_samples, margin))
}
