...
RcppExport SEXP _rsparse_fm_create_param(SEXP learning_rate_wSEXP,
                                         SEXP learning_rate_vSEXP, SEXP rankSEXP,
                                         SEXP lambda_wSEXP, SEXP lambda_vSEXP,
                                         SEXP w0_RSEXP, SEXP w_RSEXP, SEXP v_RSEXP,
                                         SEXP grad_w2_RSEXP, SEXP grad_v2_RSEXP,
                                         SEXP taskSEXP, SEXP interceptSEXP) {
  BEGIN_RCPP
  ...
  rcpp_result_gen = Rcpp::wrap(fm_create_param(learning_rate_w, learning_rate_v, rank,
                                               lambda_w, lambda_v, w0_R, w_R, v_R,
                                               grad_w2_R, grad_v2_R, task, intercept));
...
Rcpp::NumericVector fm_partial_fit(SEXP ptr, const Rcpp::S4& X,
                                   ...
                                   const Rcpp::NumericVector& w, int n_threads,
                                   int do_update);
RcppExport SEXP _rsparse_fm_partial_fit(SEXP ptrSEXP, SEXP XSEXP, SEXP ySEXP, SEXP wSEXP,
                                        SEXP n_threadsSEXP, SEXP do_updateSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
NumericVector ftrl_partial_fit(const S4& m, const NumericVector& y, const List& R_model,
                               const NumericVector& weights, int do_update,
                               int n_threads);
RcppExport SEXP _rsparse_ftrl_partial_fit(SEXP mSEXP, SEXP ySEXP, SEXP R_modelSEXP,
                                          SEXP weightsSEXP, SEXP do_updateSEXP,
                                          SEXP n_threadsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  Rcpp::traits::input_parameter<int>::type n_threads(n_threadsSEXP);
  rcpp_result_gen =
      Rcpp::wrap(ftrl_partial_fit(m, y, R_model, weights, do_update, n_threads));
  return rcpp_result_gen;
  END_RCPP
}
// cpp_glove_create
...
double cpp_glove_partial_fit(SEXP ptr, const IntegerVector& x_irow,
                             ...
                             const IntegerVector& iter_order, int n_threads);
RcppExport SEXP _rsparse_cpp_glove_partial_fit(SEXP ptrSEXP, SEXP x_irowSEXP,
                                               SEXP x_icolSEXP, SEXP x_valSEXP,
                                               SEXP iter_orderSEXP, SEXP n_threadsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<SEXP>::type ptr(ptrSEXP);
  ...
  rcpp_result_gen = Rcpp::wrap(
      cpp_glove_partial_fit(ptr, x_irow, x_icol, x_val, iter_order, n_threads));
  return rcpp_result_gen;
  END_RCPP
}
// arma_kmeans
...
RcppExport SEXP _rsparse_arma_kmeans(SEXP xSEXP, SEXP kSEXP, SEXP seed_modeSEXP,
                                     SEXP n_iterSEXP, SEXP verboseSEXP, SEXP resultSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _rsparse_copy_csr_rows(SEXP indptrSEXP, SEXP indicesSEXP, SEXP valuesSEXP,
                                       SEXP rows_takeSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _rsparse_copy_csr_rows_col_seq(SEXP indptrSEXP, SEXP indicesSEXP,
                                               SEXP valuesSEXP, SEXP rows_takeSEXP,
                                               SEXP cols_takeSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  rcpp_result_gen =
      Rcpp::wrap(copy_csr_rows_col_seq(indptr, indices, values, rows_take, cols_take));
  return rcpp_result_gen;
  END_RCPP
}
// copy_csr_arbitrary
Rcpp::List copy_csr_arbitrary(Rcpp::IntegerVector indptr, Rcpp::IntegerVector indices,
                              Rcpp::NumericVector values, Rcpp::IntegerVector rows_take,
                              Rcpp::IntegerVector cols_take);
RcppExport SEXP _rsparse_copy_csr_arbitrary(SEXP indptrSEXP, SEXP indicesSEXP,
                                            SEXP valuesSEXP, SEXP rows_takeSEXP,
                                            SEXP cols_takeSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  ...
  Rcpp::traits::input_parameter<Rcpp::IntegerVector>::type cols_take(cols_takeSEXP);
  rcpp_result_gen =
      Rcpp::wrap(copy_csr_arbitrary(indptr, indices, values, rows_take, cols_take));
  return rcpp_result_gen;
  END_RCPP
}
...
Rcpp::NumericMatrix csr_dense_tcrossprod(const Rcpp::S4& x_csr_r,
                                         ...
                                         int num_threads);
RcppExport SEXP _rsparse_csr_dense_tcrossprod(SEXP x_csr_rSEXP, SEXP y_transposedSEXP,
                                              SEXP num_threadsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<const Rcpp::S4&>::type x_csr_r(x_csr_rSEXP);
  Rcpp::traits::input_parameter<const arma::Mat<double>&>::type y_transposed(
      y_transposedSEXP);
...
Rcpp::NumericMatrix dense_csc_prod(const Rcpp::NumericMatrix& x_r,
                                   const Rcpp::S4& y_csc_r, int num_threads);
RcppExport SEXP _rsparse_dense_csc_prod(SEXP x_rSEXP, SEXP y_csc_rSEXP,
                                        SEXP num_threadsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
Rcpp::IntegerMatrix top_product(const arma::mat& x, const arma::mat& y, unsigned k,
                                ...
                                const double glob_mean);
RcppExport SEXP _rsparse_top_product(SEXP xSEXP, SEXP ySEXP, SEXP kSEXP,
                                     SEXP n_threadsSEXP, SEXP not_recommend_rSEXP,
                                     SEXP excludeSEXP, SEXP glob_meanSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  Rcpp::traits::input_parameter<const Rcpp::S4&>::type not_recommend_r(
      not_recommend_rSEXP);
  ...
  rcpp_result_gen =
      Rcpp::wrap(top_product(x, y, k, n_threads, not_recommend_r, exclude, glob_mean));
  return rcpp_result_gen;
  END_RCPP
}
// c_nnls_double
arma::Mat<double> c_nnls_double(const arma::mat& x, const arma::vec& y, uint max_iter,
                                double rel_tol);
RcppExport SEXP _rsparse_c_nnls_double(SEXP xSEXP, SEXP ySEXP, SEXP max_iterSEXP,
                                       SEXP rel_tolSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
void rankmf_solver_double(const Rcpp::S4& x_r, arma::Mat<double>& W, arma::Mat<double>& H,
                          arma::Col<double>& W2_grad, arma::Col<double>& H2_grad,
                          const Rcpp::S4& user_features_r,
                          const Rcpp::S4& item_features_r, const arma::uword rank,
                          const arma::uword n_updates, double learning_rate, double gamma,
                          double lambda_user, double lambda_item_positive,
                          double lambda_item_negative, const arma::uword n_threads,
                          bool update_items, const arma::uword loss,
                          const arma::uword kernel, arma::uword max_negative_samples,
                          double margin, const arma::uword optimizer,
                          const arma::uword report_progress);
RcppExport SEXP _rsparse_rankmf_solver_double(
    SEXP x_rSEXP, SEXP WSEXP, SEXP HSEXP, SEXP W2_gradSEXP, SEXP H2_gradSEXP,
    SEXP user_features_rSEXP, SEXP item_features_rSEXP, SEXP rankSEXP, SEXP n_updatesSEXP,
    SEXP learning_rateSEXP, SEXP gammaSEXP, SEXP lambda_userSEXP,
    SEXP lambda_item_positiveSEXP, SEXP lambda_item_negativeSEXP, SEXP n_threadsSEXP,
    SEXP update_itemsSEXP, SEXP lossSEXP, SEXP kernelSEXP, SEXP max_negative_samplesSEXP,
    SEXP marginSEXP, SEXP optimizerSEXP, SEXP report_progressSEXP) {
  BEGIN_RCPP
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  Rcpp::traits::input_parameter<const Rcpp::S4&>::type user_features_r(
      user_features_rSEXP);
  Rcpp::traits::input_parameter<const Rcpp::S4&>::type item_features_r(
      item_features_rSEXP);
  ...
  Rcpp::traits::input_parameter<double>::type lambda_item_positive(
      lambda_item_positiveSEXP);
  Rcpp::traits::input_parameter<double>::type lambda_item_negative(
      lambda_item_negativeSEXP);
  ...
  Rcpp::traits::input_parameter<arma::uword>::type max_negative_samples(
      max_negative_samplesSEXP);
  ...
  Rcpp::traits::input_parameter<const arma::uword>::type report_progress(
      report_progressSEXP);
  rankmf_solver_double(x_r, W, H, W2_grad, H2_grad, user_features_r, item_features_r,
...
// rankmf_solver_float
void rankmf_solver_float(const Rcpp::S4& x_r, Rcpp::S4& W, Rcpp::S4& H, Rcpp::S4& W2_grad,
                         Rcpp::S4& H2_grad, const Rcpp::S4& user_features_r,
                         const Rcpp::S4& item_features_r, const arma::uword rank,
                         const arma::uword n_updates, float learning_rate, float gamma,
                         float lambda_user, float lambda_item_positive,
                         float lambda_item_negative, const arma::uword n_threads,
                         bool update_items, const arma::uword loss,
                         const arma::uword kernel, arma::uword max_negative_samples,
                         float margin, const arma::uword optimizer,
                         const arma::uword report_progress);
RcppExport SEXP _rsparse_rankmf_solver_float(
    SEXP x_rSEXP, SEXP WSEXP, SEXP HSEXP, SEXP W2_gradSEXP, SEXP H2_gradSEXP,
    SEXP user_features_rSEXP, SEXP item_features_rSEXP, SEXP rankSEXP, SEXP n_updatesSEXP,
    SEXP learning_rateSEXP, SEXP gammaSEXP, SEXP lambda_userSEXP,
    SEXP lambda_item_positiveSEXP, SEXP lambda_item_negativeSEXP, SEXP n_threadsSEXP,
  ...
  Rcpp::traits::input_parameter<float>::type lambda_item_positive(
      lambda_item_positiveSEXP);
  Rcpp::traits::input_parameter<float>::type lambda_item_negative(
      lambda_item_negativeSEXP);
  Rcpp::traits::input_parameter<const arma::uword>::type n_threads(n_threadsSEXP);
  Rcpp::traits::input_parameter<bool>::type update_items(update_itemsSEXP);
  Rcpp::traits::input_parameter<const arma::uword>::type loss(lossSEXP);
  ...
  Rcpp::traits::input_parameter<const arma::uword>::type report_progress(
      report_progressSEXP);
  rankmf_solver_float(x_r, W, H, W2_grad, H2_grad, user_features_r, item_features_r, rank,
                      n_updates, learning_rate, gamma, lambda_user, lambda_item_positive,
                      lambda_item_negative, n_threads, update_items, loss, kernel,
                      max_negative_samples, margin, optimizer, report_progress);
  return R_NilValue;
  END_RCPP
}
// omp_thread_count
...
Rcpp::NumericVector cpp_make_sparse_approximation(const Rcpp::S4& mat_template,
                                                  ...
                                                  unsigned n_threads);
RcppExport SEXP _rsparse_cpp_make_sparse_approximation(SEXP mat_templateSEXP, SEXP XSEXP,
                                                       SEXP YSEXP,
                                                       SEXP sparse_matrix_typeSEXP,
                                                       SEXP n_threadsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  Rcpp::traits::input_parameter<unsigned>::type n_threads(n_threadsSEXP);
  rcpp_result_gen = Rcpp::wrap(
      cpp_make_sparse_approximation(mat_template, X, Y, sparse_matrix_type, n_threads));
  return rcpp_result_gen;
  END_RCPP
}
// large_rand_matrix
...
RcppExport SEXP _rsparse_als_explicit_double(SEXP m_csc_rSEXP, SEXP XSEXP, SEXP YSEXP,
                                             SEXP cnt_XSEXP, SEXP lambdaSEXP,
                                             SEXP n_threadsSEXP, SEXP solverSEXP,
                                             SEXP cg_stepsSEXP, SEXP dynamic_lambdaSEXP,
                                             SEXP with_biasesSEXP,
                                             SEXP is_x_bias_last_rowSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  rcpp_result_gen = Rcpp::wrap(
      als_explicit_double(m_csc_r, X, Y, cnt_X, lambda, n_threads, solver, cg_steps,
                          dynamic_lambda, with_biases, is_x_bias_last_row));
  return rcpp_result_gen;
  END_RCPP
}
// als_explicit_float
double als_explicit_float(const Rcpp::S4& m_csc_r, Rcpp::S4& X_, Rcpp::S4& Y_,
                          ...
                          unsigned solver, unsigned cg_steps, const bool dynamic_lambda,
                          const bool with_biases, bool is_x_bias_last_row);
RcppExport SEXP _rsparse_als_explicit_float(SEXP m_csc_rSEXP, SEXP X_SEXP, SEXP Y_SEXP,
                                            SEXP cnt_X_SEXP, SEXP lambdaSEXP,
                                            SEXP n_threadsSEXP, SEXP solverSEXP,
                                            SEXP cg_stepsSEXP, SEXP dynamic_lambdaSEXP,
                                            SEXP with_biasesSEXP,
                                            SEXP is_x_bias_last_rowSEXP) {
  ...
  Rcpp::traits::input_parameter<bool>::type is_x_bias_last_row(is_x_bias_last_rowSEXP);
  rcpp_result_gen = Rcpp::wrap(
      als_explicit_float(m_csc_r, X_, Y_, cnt_X_, lambda, n_threads, solver, cg_steps,
                         dynamic_lambda, with_biases, is_x_bias_last_row));
  return rcpp_result_gen;
  END_RCPP
}
...
RcppExport SEXP _rsparse_als_implicit_double(SEXP m_csc_rSEXP, SEXP XSEXP, SEXP YSEXP,
                                             SEXP XtXSEXP, SEXP lambdaSEXP,
                                             SEXP n_threadsSEXP, SEXP solverSEXP,
                                             SEXP cg_stepsSEXP, SEXP with_biasesSEXP,
                                             SEXP is_x_bias_last_rowSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  Rcpp::traits::input_parameter<bool>::type is_x_bias_last_row(is_x_bias_last_rowSEXP);
  rcpp_result_gen =
      Rcpp::wrap(als_implicit_double(m_csc_r, X, Y, XtX, lambda, n_threads, solver,
...
double als_implicit_float(const Rcpp::S4& m_csc_r, Rcpp::S4& X_, Rcpp::S4& Y_,
                          ...
                          unsigned solver, unsigned cg_steps, const bool with_biases,
                          bool is_x_bias_last_row);
RcppExport SEXP _rsparse_als_implicit_float(SEXP m_csc_rSEXP, SEXP X_SEXP, SEXP Y_SEXP,
                                            SEXP XtX_SEXP, SEXP lambdaSEXP,
                                            SEXP n_threadsSEXP, SEXP solverSEXP,
                                            SEXP cg_stepsSEXP, SEXP with_biasesSEXP,
                                            SEXP is_x_bias_last_rowSEXP) {
  BEGIN_RCPP
  ...
  Rcpp::traits::input_parameter<bool>::type is_x_bias_last_row(is_x_bias_last_rowSEXP);
  rcpp_result_gen =
      Rcpp::wrap(als_implicit_float(m_csc_r, X_, Y_, XtX_, lambda, n_threads, solver,
                                    cg_steps, with_biases, is_x_bias_last_row));
  return rcpp_result_gen;
  END_RCPP
}
...
RcppExport SEXP _rsparse_initialize_biases_double(SEXP m_csc_rSEXP, SEXP m_csr_rSEXP,
                                                  SEXP user_biasSEXP, SEXP item_biasSEXP,
                                                  SEXP lambdaSEXP,
                                                  SEXP dynamic_lambdaSEXP,
                                                  SEXP non_negativeSEXP,
  ...
  Rcpp::traits::input_parameter<bool>::type calculate_global_bias(
      calculate_global_biasSEXP);
  rcpp_result_gen = Rcpp::wrap(
...
double initialize_biases_float(const Rcpp::S4& m_csc_r, const Rcpp::S4& m_csr_r,
                               ...
                               bool dynamic_lambda, bool non_negative,
                               bool calculate_global_bias);
RcppExport SEXP _rsparse_initialize_biases_float(SEXP m_csc_rSEXP, SEXP m_csr_rSEXP,
                                                 SEXP user_biasSEXP, SEXP item_biasSEXP,
                                                 SEXP lambdaSEXP, SEXP dynamic_lambdaSEXP,
                                                 SEXP non_negativeSEXP,
                                                 SEXP calculate_global_biasSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rsparse_cpp_make_sparse_approximation",
     (DL_FUNC)&_rsparse_cpp_make_sparse_approximation, 5},
