...
// als_explicit_double
double als_explicit_double(const Rcpp::S4& m_csc_r, arma::mat& X, arma::mat& Y, arma::Col<double> cnt_X, double lambda, double lambda_l1, unsigned int n_threads, unsigned int solver, unsigned int cg_steps, unsigned int cd_steps, const bool cd_until_conv, const bool dynamic_lambda, const bool with_biases, bool is_x_bias_last_row);
RcppExport SEXP _rsparse_als_explicit_double(SEXP m_csc_rSEXP, SEXP XSEXP, SEXP YSEXP, SEXP cnt_XSEXP, SEXP lambdaSEXP, SEXP lambda_l1SEXP, SEXP n_threadsSEXP, SEXP solverSEXP, SEXP cg_stepsSEXP, SEXP cd_stepsSEXP, SEXP cd_until_convSEXP, SEXP dynamic_lambdaSEXP, SEXP with_biasesSEXP, SEXP is_x_bias_last_rowSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< unsigned int >::type solver(solverSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type cg_steps(cg_stepsSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type cd_steps(cd_stepsSEXP);
    Rcpp::traits::input_parameter< const bool >::type cd_until_conv(cd_until_convSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(als_explicit_double(m_csc_r, X, Y, cnt_X, lambda, lambda_l1, n_threads, solver, cg_steps, cd_steps, cd_until_conv, dynamic_lambda, with_biases, is_x_bias_last_row));
    return rcpp_result_gen;
END_RCPP
}
// als_explicit_float
double als_explicit_float(const Rcpp::S4& m_csc_r, Rcpp::S4& X_, Rcpp::S4& Y_, Rcpp::S4& cnt_X_, double lambda, double lambda_l1, unsigned n_threads, unsigned int solver, unsigned int cg_steps, unsigned int cd_steps, const bool cd_until_conv, const bool dynamic_lambda, const bool with_biases, bool is_x_bias_last_row);
RcppExport SEXP _rsparse_als_explicit_float(SEXP m_csc_rSEXP, SEXP X_SEXP, SEXP Y_SEXP, SEXP cnt_X_SEXP, SEXP lambdaSEXP, SEXP lambda_l1SEXP, SEXP n_threadsSEXP, SEXP solverSEXP, SEXP cg_stepsSEXP, SEXP cd_stepsSEXP, SEXP cd_until_convSEXP, SEXP dynamic_lambdaSEXP, SEXP with_biasesSEXP, SEXP is_x_bias_last_rowSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::S4& >::type m_csc_r(m_csc_rSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type with_biases(with_biasesSEXP);
    Rcpp::traits::input_parameter< bool >::type is_x_bias_last_row(is_x_bias_last_rowSEXP);
    rcpp_result_gen = Rcpp::wrap(als_explicit_float(m_csc_r, X_, Y_, cnt_X_, lambda, lambda_l1, n_threads, solver, cg_steps, cd_steps, cd_until_conv, dynamic_lambda, with_biases, is_x_bias_last_row));
    return rcpp_result_gen;
END_RCPP
}
// als_implicit_double
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rsparse_als_explicit_double", (DL_FUNC) &_rsparse_als_explicit_double, 14},
