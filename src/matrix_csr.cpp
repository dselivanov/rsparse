...
Rcpp::NumericVector multiply_csr_by_dense_elemwise(Rcpp::IntegerVector indptr, Rcpp::IntegerVector indices, Rcpp::NumericVector values, RcppVector dense_mat)
{
...
/* TODO: add function to sort indices */
